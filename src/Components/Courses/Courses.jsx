...
<div className='courses' id='courses'>
    ...
    <div className='coursecard'>
        ...
        <div className="coursecardbody">
            ...
            <a target='_blank' href="https://docs.google.com/forms/d/e/1FAIpQLScTV7r8YyHE_RC-ovL4lmTLghMLRYdrbKjeaXx-kTNka-49bQ/viewform?vc=0&c=0&w=1&flr=0"><button className='course-btn'>Start the Quiz</button></a>
        </div>
    </div>
    ...
    <div className='coursecard'>
        ...
        <div className="coursecardbody">
            ...
            <a target='_blank' href="https://docs.google.com/forms/d/e/1FAIpQLSe3gu3lsVoNL_oAeLE9BwCtA4wmnV5KE-P4ObKSvfVQf2D7WQ/viewform?vc=0&c=0&w=1&flr=0"><button className='course-btn'>Start the Quiz</button></a>
